  ...
  tagList(
    ...
    tabPanel("About",
         ...
         HTML('
              ...
              <br>please <a href="mailto:" class="aboutMail"><b>email</b></a> us for more details.
              <br><br>If you have further questions relating to the datasets available,
              <br>please <a href="mailto:" class="aboutMail"><b>email</b></a> the <b>health data science</b> team and we would be happy to help.
              </span>
              </div>
              </section>
