aboutOutput <- function(id){
  ...
  tagList(
    ...
    Please contact the <a href="" class="aboutMail"><b>BHF DSC Health Data Science Team</b></a> if you would like to discuss the scope and feasibility of a potential project in more detail. 
    For any enquiries about the application process for accessing data in the TREs please contact the <a href="." class="aboutMail"><b>BHF DSC</b></a>. 
      ...
      <div class="text-box">
        ...
        <p>
          <br>For each of the datasets available, the dashboard provides: a basic description; links to further sources of more information (e.g., Health Data Research Innovation Gateway); the data dictionary; overall number of records; the data coverage over time; and the completeness of each variable. 
              ...
              For further information about the dashboard please contact the <a href="" class="aboutMail"><b>BHF DSC Health Data Science Team</b></a>. For any enquiries about the application process for accessing data in the TREs please contact the <a href="." class="aboutMail"><b>BHF DSC</b></a>.
              <br><br>
