...
<div class="card-wrapper  | content-cc">
  ...
  <div class="faq-card">
    ...
    <br><br>Please contact the <a href="" class="aboutMail"><b>BHF Data Science Centre Health Data Science Team</b></a> if you would like to discuss the scope and feasibility of a potential project in more detail. 
    <br><br>For any enquiries about the application process for accessing data in the TREs please contact the <a href="." class="aboutMail"><b>BHF Data Science Centre</b></a>. 
        ...
        <article class="faq-accordion">
          ...
          <div class="faq-accordion-content">
            <p>For each of the datasets available, the dashboard provides: a basic description; links to further sources of more information (e.g., Health Data Research Innovation Gateway); the data dictionary; overall number of records; the data coverage over time; and the completeness of each variable. 
              ...
              <br><br>For further information about the dashboard please contact the <a href="" class="aboutMail"><b>BHF Data Science Centre Health Data Science Team</b></a>. For any enquiries about the application process for accessing data in the TREs please contact the <a href="." class="aboutMail"><b>BHF Data Science Centre</b></a>.
              <br><br>
